...
percentile_2.5 <- quantile(df_task1_vcoef[,2], 0.025)
percentile_97.5 <- quantile(df_task1_vcoef[,2], 0.975)
mean_value <- mean(df_task1_vcoef[,2])
#showing the posterior probability density distribution of the coefficient
figure <- ggplot(df_task1_vcoef, aes(x = df_task1_vcoef[, 2])) +
  geom_density() +
...
ggplot2::ggsave(
  filename = '../figure/main_effect.jpg',
  plot = figure_main,                
  width = 200,                       
  height = 200*2/3,                       
  units = "mm",
